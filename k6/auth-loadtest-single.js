...
const SCENARIO = (__ENV.SCENARIO || "auth").toLowerCase(); // auth | users | assignments
...
function thresholdsByScenario(scenario) {
  const base = {
...
export const options = {
  ...
  thresholds: thresholdsByScenario(SCENARIO),
...
export function setup() {
  ...
  let adminToken = "";
  if (SCENARIO === "users" || SCENARIO === "assignments") {
